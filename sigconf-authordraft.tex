...
\caption{Study interfaces shown to participants. \textbf{Left (Baseline):} a conventional linear chat interface alongside a PDF viewer; AI responses and source text remain in separate panes. \textbf{Right (StructWeaver):} hierarchical node workspace with gist--verbatim alignment, verbatim panel, and AI response panel.}
